		...
		<div className="resume-wrapper">
			<section
				className={`top-section${
					darkMode === "dark" ? "" : " top-section-light-mode"
				}`}
			>
								...
								<div className="profile">
									...
									<div className="profile__content">
										<p>
											...
											full stack web developer
											certification at Bloom Tech and is
											seeking a full-time developer role
											at entry level. Lorem ipsum dolor
										...
										<div className="skills__content">
											{skills.map((skill, idx) => {
												return (
													<div
														key={idx}
														className="skill resume-item-card"
													>
														<h4>{skill.stack}</h4>
														<ul>
															{skill.list.map(
										...
										<div className="education__content">
											{education.map((edu) => {
												return (
													<div
														key={edu.school}
														className="school resume-item-card"
													>
														<h4>{edu.major}</h4>
														{edu.gpa !== "" ? (
															<div>
										...
										<div className="projects__content">
											{projects.map((p) => {
												return (
													<div
														key={p.title}
														className="project resume-item-card"
													>
